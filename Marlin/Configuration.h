...
#define STRING_CONFIG_H_AUTHOR "(Pedro Martins, reprap.pt)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "V19" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "http://reprap.pt"         // will be shown during bootup in line 2
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //i3d mk2b or mk3 heatbed
    #define  DEFAULT_bedKp 62.45
    #define  DEFAULT_bedKi 9.08
    #define  DEFAULT_bedKd 107.44
 ...
 */
// for T8
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 156 }
// for 5mm 
